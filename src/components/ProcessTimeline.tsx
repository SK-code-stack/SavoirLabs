...
export default function ProcessTimeline() {
  ...
  return (
    <section ref={containerRef} id="process" className="py-28 bg-[#07070b] text-white relative">
          ...
          <div className="flex flex-col gap-16">
            {steps.map((step, idx) => {
              ...
              return (
                ...
                >
                  {/* Center Node Button */}
                  <div className="absolute left-4 sm:left-1/2 -translate-x-1/2 top-0 z-10 w-10 h-10 rounded-full bg-[#0d0d16] border-2 border-[#ff0033] flex items-center justify-center text-[#ff0033] shadow-[0_0_25px_rgba(255,0,51,0.6)]">
                  ...
                  <div className={`w-full sm:w-[calc(50%-3rem)] pl-12 sm:pl-0 ${isEven ? "sm:pr-8" : "sm:pl-8"}`}>
                    <motion.div
                      ...
                      className="p-6 sm:p-8 rounded-2xl bg-[#0d0d16] border border-[#ff0033]/30 hover:border-[#ff0033] hover:shadow-[0_0_35px_rgba(255,0,51,0.3)] transition-all duration-300 interactive"
                    >
                      <span className="text-xs font-mono text-[#ff0033] tracking-widest block mb-1 font-bold">
                        {step.phase}
                      </span>
